...
export default function KategoriGuruEdit({ kategori }) {
    ...
    const handleSubmit = async (e) => {
        ...
        put(`/admin/kategori-guru/${kategori.id}`);
    };
            ...
            <div className="max-w-3xl mx-auto py-12 px-6 animate-in fade-in duration-700">
                <header className="mb-10 flex items-center justify-between">
                    <div className="space-y-1">
                        <h1 className="text-4xl font-black tracking-tighter uppercase italic text-slate-900 leading-none">EDIT KATEGORI</h1>
                        <p className="text-xs font-bold text-slate-400 uppercase tracking-widest flex items-center gap-2">
                             <RefreshCw className="h-3 w-3" /> Memperbarui meta data kategori pengajar.
                        </p>
                    </div>
                ...
                <form onSubmit={handleSubmit}>
                    <Card className="rounded-[3rem] border shadow-2xl overflow-hidden glass-card">
                        <CardContent className="p-10 lg:p-16 space-y-10">
                            ...
                            <div className="space-y-4">
                                <label className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 ml-2">Detail Deskripsi</label>
                                <div className="relative group">
                            ...
                            <div className="pt-6">
                                <Button 
                                    type="submit" 
                                    disabled={processing}
                                    className="w-full h-20 rounded-[2.5rem] bg-slate-900 text-white font-black tracking-[0.2em] text-xs shadow-2xl hover:bg-emerald-600 transition-all active:scale-95"
                                >
