...
export default function GuruCreate() {
    const { data, setData, post, processing, errors } = useForm({
        name: '', email: '', password: '', password_confirmation: '', nis: '',
    });
        ...
        <AppLayout>
            <div className="max-w-2xl mx-auto space-y-6">
                <div className="flex items-center justify-between">
                    <h2 className="text-2xl font-bold">Tambah Guru</h2>
                ...
                <div className="bg-white rounded-xl border shadow-sm p-6">
                    <form onSubmit={handleSubmit} className="space-y-4">
                        {[
                            { label: 'Nama Lengkap', key: 'name', type: 'text', placeholder: 'Nama guru...' },
                            { label: 'Email', key: 'email', type: 'email', placeholder: 'email@sekolah.sch.id' },
                            { label: 'NIS/NIP', key: 'nis', type: 'text', placeholder: 'Nomor induk (opsional)' },
                        ...
                        <div className="flex justify-end gap-3 pt-4 border-t">
                            ...
                            <Button type="submit" disabled={processing} className="gap-2"><Save className="h-4 w-4" /> Simpan</Button>
                        </div>
                    </form>
                </div>
            </div>
